...
*Dark mode* is such a silly thing. One must be born after 2000 to enjoy it.
...
In a few years, everybody will understand this when the disappointment between the over-hyped expectations and reality with respect to AI settles in. Or when everybody becomes busy hyping the next big thing from which we will expect everything. Nothing's new under the sun.
